...
public class Direct_fired_lithium_bromide {
    private Integer id;
    ...
    private Double ratedHeatingPower;

    private Double ratedCoolingPower;
    ...
    public Double getRatedHeatingPower() {
        return ratedHeatingPower;
    }

    public void setRatedHeatingPower(Double ratedHeatingPower) {
        this.ratedHeatingPower = ratedHeatingPower;
    }

    public Double getRatedCoolingPower() {
        return ratedCoolingPower;
    }

    public void setRatedCoolingPower(Double ratedCoolingPower) {
        this.ratedCoolingPower = ratedCoolingPower;
    }
