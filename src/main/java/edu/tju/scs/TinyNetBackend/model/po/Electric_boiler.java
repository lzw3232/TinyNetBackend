...
public class Electric_boiler {
    ...
    private Double electricalRating;
    ...
    public Double getElectricalRating() {
        return electricalRating;
    }

    public void setElectricalRating(Double electricalRating) {
