...
public class Gas_engine {
    ...
    private Double coWaterPowerRatio;

    private Double gasEleRatio;
    ...
    public Double getCoWaterPowerRatio() {
        return coWaterPowerRatio;
    }

    public void setCoWaterPowerRatio(Double coWaterPowerRatio) {
        this.coWaterPowerRatio = coWaterPowerRatio;
    }

    public Double getGasEleRatio() {
        return gasEleRatio;
    }

    public void setGasEleRatio(Double gasEleRatio) {
        this.gasEleRatio = gasEleRatio;
    }
