...
public class Host {
    ...
    private Double ratedIceElectricPower;

    private Double ratedRefrigeratingElectricPower;

    private String manufacturer;

    private Double iceConsumptionCoefficient;
    ...
    public Double getIceRatio() {
        return iceRatio;
    }

    public void setIceRatio(Double iceRatio) {
        this.iceRatio = iceRatio;
    }
    ...
    public Double getRatedIceElectricPower() {
        return ratedIceElectricPower;
    }

    public void setRatedIceElectricPower(Double ratedIceElectricPower) {
        this.ratedIceElectricPower = ratedIceElectricPower;
    }
    ...
    public Double getIceConsumptionCoefficient() {
        return iceConsumptionCoefficient;
    }

    public void setIceConsumptionCoefficient(Double iceConsumptionCoefficient) {
        this.iceConsumptionCoefficient = iceConsumptionCoefficient;
    }
