...
public class Hydro_turbine {
    private Integer id;

    private String name;

    private Double netWaterhead;
    ...
    public Double getNetWaterhead() {
        return netWaterhead;
    }

    public void setNetWaterhead(Double netWaterhead) {
        this.netWaterhead = netWaterhead;
    }
