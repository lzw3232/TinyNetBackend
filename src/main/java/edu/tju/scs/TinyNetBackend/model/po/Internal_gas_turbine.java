...
public class Internal_gas_turbine {
    private Integer id;
    ...
    private String fInternalGasPower;

    private String internalgasConsumption;
    ...
    public String getfInternalGasPower() {
        return fInternalGasPower;
    }

    public void setfInternalGasPower(String fInternalGasPower) {
        this.fInternalGasPower = fInternalGasPower == null ? null : fInternalGasPower.trim();
    }

    public String getInternalgasConsumption() {
        return internalgasConsumption;
    }

    public void setInternalgasConsumption(String internalgasConsumption) {
        this.internalgasConsumption = internalgasConsumption == null ? null : internalgasConsumption.trim();
    }
