...
public class Lithium_bromide {
    private Integer id;

    private String name;

    private Double heatingEnergyEfficiencyRatio;

    private Double refrigerationEnergyEfficiencyRatio;

    private Double ratedHeatingFlueGasPower;

    private Double ratedCoolingFlueGasPower;
    ...
    private Integer numberOfUnits3;

    private Integer numberOfUnits4;
    ...
    public Double getHeatingEnergyEfficiencyRatio() {
        return heatingEnergyEfficiencyRatio;
    }

    public void setHeatingEnergyEfficiencyRatio(Double heatingEnergyEfficiencyRatio) {
        this.heatingEnergyEfficiencyRatio = heatingEnergyEfficiencyRatio;
    }

    public Double getRefrigerationEnergyEfficiencyRatio() {
        return refrigerationEnergyEfficiencyRatio;
    }

    public void setRefrigerationEnergyEfficiencyRatio(Double refrigerationEnergyEfficiencyRatio) {
        this.refrigerationEnergyEfficiencyRatio = refrigerationEnergyEfficiencyRatio;
    }

    public Double getRatedHeatingFlueGasPower() {
        return ratedHeatingFlueGasPower;
    }

    public void setRatedHeatingFlueGasPower(Double ratedHeatingFlueGasPower) {
        this.ratedHeatingFlueGasPower = ratedHeatingFlueGasPower;
    }

    public Double getRatedCoolingFlueGasPower() {
        return ratedCoolingFlueGasPower;
    }

    public void setRatedCoolingFlueGasPower(Double ratedCoolingFlueGasPower) {
        this.ratedCoolingFlueGasPower = ratedCoolingFlueGasPower;
    }
    ...
    public Integer getNumberOfUnits1() {
        return numberOfUnits1;
    }

    public void setNumberOfUnits1(Integer numberOfUnits1) {
        this.numberOfUnits1 = numberOfUnits1;
    }
    ...
    public Integer getNumberOfUnits3() {
        return numberOfUnits3;
    }

    public void setNumberOfUnits3(Integer numberOfUnits3) {
        this.numberOfUnits3 = numberOfUnits3;
    }

    public Integer getNumberOfUnits4() {
        return numberOfUnits4;
    }

    public void setNumberOfUnits4(Integer numberOfUnits4) {
        this.numberOfUnits4 = numberOfUnits4;
    }
