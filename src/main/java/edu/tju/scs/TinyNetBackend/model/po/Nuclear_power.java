...
public class Nuclear_power {
    private Integer id;

    private String name;

    private Double minimulLoadRate;

    private Double generationMaxrate;

    private Double fmFactor;

    private Double nuclearFuelPrice;

    private Double nuclearFuelNumber;

    private Double nuclearFuelRep;
    ...
    public Double getMinimulLoadRate() {
        return minimulLoadRate;
    }

    public void setMinimulLoadRate(Double minimulLoadRate) {
        this.minimulLoadRate = minimulLoadRate;
    }

    public Double getGenerationMaxrate() {
        return generationMaxrate;
    }

    public void setGenerationMaxrate(Double generationMaxrate) {
        this.generationMaxrate = generationMaxrate;
    }

    public Double getFmFactor() {
        return fmFactor;
    }

    public void setFmFactor(Double fmFactor) {
        this.fmFactor = fmFactor;
    }

    public Double getNuclearFuelPrice() {
        return nuclearFuelPrice;
    }

    public void setNuclearFuelPrice(Double nuclearFuelPrice) {
        this.nuclearFuelPrice = nuclearFuelPrice;
    }

    public Double getNuclearFuelNumber() {
        return nuclearFuelNumber;
    }

    public void setNuclearFuelNumber(Double nuclearFuelNumber) {
        this.nuclearFuelNumber = nuclearFuelNumber;
    }

    public Double getNuclearFuelRep() {
        return nuclearFuelRep;
    }

    public void setNuclearFuelRep(Double nuclearFuelRep) {
        this.nuclearFuelRep = nuclearFuelRep;
    }
